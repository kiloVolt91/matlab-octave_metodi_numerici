% Minimi quadrati nel discreto cubico
clc, clear all, close all

u=4 % Grado del polinomio (funzione approssimante, u=1 retta, u=2 parabola ...)
...
m=x.^3 %quarta colonna della matrice A
n=length(x)
...
for i=1:n
    ...
    A(i,4)=m(i)  % Sostituzione dei valori di m nella quarta colonna
end
